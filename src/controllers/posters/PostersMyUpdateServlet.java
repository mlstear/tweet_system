...
/**
 * Servlet implementation class PostersMyUpdateServlet
 */
@WebServlet("/posters/myUpdate")
public class PostersMyUpdateServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public PostersMyUpdateServlet() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(_token !=null&&_token.equals(request.getSession().getId())){
            ...
            Poster p = em.find(Poster.class , (Integer)(request.getSession().getAttribute("login_poster_id")));
            ...
            if(errors.size()>0){
                ...
                response.sendRedirect(request.getContextPath()+"/tweets/myIndex");
            }
